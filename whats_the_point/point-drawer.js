var VG = (function(vg, $) {
    ...
    */
	...
	that.EvalAnswer = function() {
	    ...
	    var bOK = true;
	    if (options.gt) {
		if (options.gt.bbox && options.gt.bbox.x) {
		    bChecked = true;		    
		    ...
		    for (var i=0; i < clicks_img.length;i++) {
			var x = clicks_img[i].x;
			var y = clicks_img[i].y;
	...
	function updateCounter() {
		...
		counterdiv.text("You found " + String(clicks.length) + " " + options.obj_plural + " so far");
	    }
	}
